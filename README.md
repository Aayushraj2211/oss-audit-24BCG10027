...
This repository is my submission for the **Open Source Audit** capstone project. The project involves a structured audit of **Git** — one of the most widely used open-source tools in the world — covering its origin story, license, Linux footprint, FOSS ecosystem, and a comparison with proprietary alternatives.
